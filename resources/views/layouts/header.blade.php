                        ...
                        <ul class="nav flex-nowrap text-nowrap">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab"
                                    href="#kt_header_navs_tab_2">Forms</a>
                            </li>
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <form data-kt-search-element="form"
                                    ...
                                    <span
                                        ...
                                        <span class="svg-icon svg-icon-2 svg-icon-lg-1 me-0"><svg
                                                width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    ...
                                                    <span
                                                        class="svg-icon svg-icon-2 svg-icon-primary"><svg
                                                            width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path opacity="0.3"
                                ...
                                <div data-kt-search-element="empty" class="text-center d-none">
                                    ...
                                    <div class="pt-10 pb-10">
                                        ...
                                        <span class="svg-icon svg-icon-4x opacity-50"><svg
                                                width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3"
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-6">
                                <a href="apps/projects/budget.html"
                                    ...
                                    <span class="svg-icon svg-icon-3x svg-icon-primary mb-2"><svg
                                            width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.3"
                                        ...
                                        <div class="menu-state-bg menu-extended overflow-hidden overflow-lg-visible"
                                            ...
                                            <div class="row">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/ecommerce.html"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="svg-icon svg-icon-danger svg-icon-1"><svg
                                                                                width="24"
                                                                                height="24"
                                                                                viewBox="0 0 24 24"
                                                                                fill="none"
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/projects.html"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="svg-icon svg-icon-info svg-icon-1"><svg
                                                                                width="24"
                                                                                height="24"
                                                                                viewBox="0 0 24 24"
                                                                                fill="none"
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/online-courses.html"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="svg-icon svg-icon-success svg-icon-1"><svg
                                                                                width="24"
                                                                                height="25"
                                                                                viewBox="0 0 24 25"
                                                                                fill="none"
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                ...
                                                                <a href="dashboards/bidding.html"
                                                                    ...
                                                                    <span
                                                                        ...
                                                                        <span
                                                                            class="svg-icon svg-icon-warning svg-icon-1"><svg
                                                                                width="24"
                                                                                height="24"
                                                                                viewBox="0 0 24 24"
                                                                                fill="none"
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="dashboards/delivery.html"
                                                            class="menu-link py-2 ">
                                                            <span class="menu-title">
                                                                Delivery </span>
                                                        </a>
                                                    ...
                                                    <div class="menu-item p-0 m-0">
                                                        <!--begin:Menu link-->
                                                        <a href="dashboards/podcast.html"
                                                            class="menu-link py-2 ">
                                                            <span class="menu-title">
                                                                Podcast </span>
                                                        </a>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="authentication/layouts/corporate/two-steps.html"
                                                                        class="menu-link ">
                                                                        <span
                                                            ...
                                                            <div class="mb-0">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="authentication/layouts/overlay/two-steps.html"
                                                                        class="menu-link ">
                                                                        <span
                                                                            class="menu-title">Two-steps</span>
                                                                    </a>
                                                        ...
                                                        <div class="col-lg-3 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="authentication/layouts/creative/two-steps.html"
                                                                        class="menu-link ">
                                                                        <span
                                                                            class="menu-title">Two-steps</span>
                                                                    </a>
                                                            ...
                                                            <div class="mb-6">
                                                                ...
                                                                <div class="menu-item p-0 m-0">
                                                                    <!--begin:Menu link-->
                                                                    <a href="authentication/layouts/fancy/two-steps.html"
                                                                        class="menu-link ">
                                                                        <span
                                                                            class="menu-title">Two-steps</span>
                                                                    </a>
                                                ...
                                                <div class="tab-pane  w-lg-500px"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-6 mb-lg-0">
                                                            ...
                                                            <div class="menu-item p-0 m-0">
                                                                <!--begin:Menu link-->
                                                                <a href="widgets/mixed.html"
                                                                    class="menu-link ">
                                                                    <span
                                                                        class="menu-title">Mixed</span>
                                                                </a>
                                                                <!--end:Menu link-->
                                                            </div>
                                                            <!--end:Menu item-->
                                    ...
                                    <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">eCommerce</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                            <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Support
                                                    Center</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">User
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Customers</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                            <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Invoice
                                                    Management</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">File
                                                    Manager</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Inbox</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                            <div
                                        ...
                                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}"
                                            ...
                                            <!--begin:Menu link--><span class="menu-link py-3"><span
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Chat</span><span
                                                    class="menu-arrow"></span></span>
                                            <!--end:Menu link-->
                                            <!--begin:Menu sub-->
                                            <div
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link--><a class="menu-link py-3"
                                                href="apps/calendar.html"><span class="menu-icon">
                                    ...
                                    <div
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link--><a class="menu-link py-3"
                                                ...
                                                data-bs-placement="right"><span class="menu-icon">
                                                    <!--begin::Svg Icon | path: icons/duotune/general/gen002.svg-->
                                                    <span class="svg-icon svg-icon-3"><svg
                                                            width="24" height="24"
                                                            viewBox="0 0 24 24" fill="none"
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Components</span></a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                        <!--begin:Menu item-->
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link--><a class="menu-link py-3"
                                                ...
                                                data-bs-placement="right"><span class="menu-icon">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Layout
                                                    Builder</span></a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                                        ...
                                        <div class="menu-item">
                                            <!--begin:Menu link--><a class="menu-link py-3"
                                                ...
                                                target="_blank"><span class="menu-icon">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                </span><span class="menu-title">Changelog
                                                    v8.1.7</span></a>
                                            <!--end:Menu link-->
                                        </div>
                                        <!--end:Menu item-->
                    ...
                    <div class="tab-pane fade" id="kt_header_navs_tab_5">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-column flex-lg-row gap-2">
                                ...
                                <a class="btn btn-sm btn-light-danger fw-bold"
                                    href="layout-builder.html">Layout Builder</a>
                            </div>
