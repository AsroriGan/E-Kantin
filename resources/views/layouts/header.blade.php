    ...
    <div class="d-flex align-items-center flex-row-auto">
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
            ...
            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-3">
                <a href="account/statements.html" class="menu-link d-flex flex-stack px-5"> Statements <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="View your statements"></i>
                </a>
                </div>
                <!--end::Menu item-->
                <!--begin::Menu separator-->
    ...
    <div class="d-lg-flex flex-column justify-content-lg-center w-100" id="kt_header_navs_wrapper">
        ...
        <div class="tab-pane fade active show" id="kt_header_navs_tab_1">
            ...
            <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-title-gray-700 menu-state-primary menu-arrow-gray-400 fw-semibold align-items-stretch flex-grow-1 px-2 px-lg-0" id="#kt_header_menu" data-kt-menu="true">
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                    ...
                    <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link py-3" href="layout-builder.html" title="Build your layout and export HTML for server side integration" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
        ...
        <div class="tab-pane fade" id="kt_header_navs_tab_2">
            ...
            <div class="d-flex flex-column flex-lg-row gap-2">
                <a class="btn btn-sm btn-light-primary fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/base/forms/controls">Controls</a>
                <a class="btn btn-sm btn-light-success fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/base/forms/advanced">Advanced</a>
                <a class="btn btn-sm btn-light-danger fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/base/forms/floating-labels">Floating Labels</a>
            </div>
            <div class="d-flex flex-column flex-lg-row gap-2">
                <a class="btn btn-sm btn-light-info fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/forms/autosize">More Components</a>
            </div>
            </div>
            <!--end::Wrapper-->
        </div>
        ...
        <div class="tab-pane fade" id="kt_header_navs_tab_5">
            ...
            <div class="d-flex flex-column flex-lg-row gap-2">
                ...
                <a class="btn btn-sm btn-light-success fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/video-tutorials">Video Tutorials</a>
                <a class="btn btn-sm btn-light-danger fw-bold" href="layout-builder.html">Layout Builder</a>
            </div>
            <div class="d-flex flex-column flex-lg-row gap-2">
                <a class="btn btn-sm btn-light-info fw-bold" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog">Changelog</a>
            </div>
            </div>
            <!--end::Wrapper-->
        </div>
