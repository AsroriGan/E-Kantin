					...
					<div class="toolbar mb-n1 pt-3 mb-lg-n3 pt-lg-6" id="kt_toolbar">
						...
						<div id="kt_toolbar_container" class=" container-xxl  d-flex flex-stack flex-wrap gap-2">
							...
							<div class="d-flex align-items-center">
								<!--begin::Button-->
								<a href="#" class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_card"> Tambah Menu Minuman</a>
								<!--end::Button-->
							</div>
							<!--end::Actions-->
						</div>
									...
									<div class="card h-100 px-9 pt-6 pb-8">
										...
										<div class="card-body d-flex p-0 mb-3">
											<div class="image-food symbol">
												<img class="p-3 bg-abu symbol" src="{{ asset('templateuser/assets/images/food/pic1.png') }}" alt="">
											</div>
											<div class="desc-food w-100">
												<div class="fs-1 fw-bold mb-2 ms-3">Kopi GodDay</div>
												<label class="fs-4 ms-3 fw-semibold text-hover-primary text-gray-600 m-0">Rp.3.000</label>
											</div>
										</div>
						...
						<form id="kt_modal_new_card_form" class="form needs-validation" method="POST" action="/menu-makananpost" novalidate="novalidate" enctype="multipart/form-data"> @csrf
							...
							<div class="d-flex flex-column mb-0 fv-row">
								...
								<div class="input-group mb-5">
									<input type="text" class="form-control form-control-solid" placeholder="Es syntax" name="nama_makanan" value="" required />
									<div class="invalid-feedback"> Harap isi bidang ini </div>
								</div>
								<!--begin::Label-->
								<label class="d-flex align-items-center fs-6 fw-semibold form-label mb-2">
