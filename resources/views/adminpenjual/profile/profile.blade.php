...
<span class="svg-icon svg-icon-4 m-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div data-kt-stepper-element="content">
    ...
    <div class="w-100">
        ...
        <div class="fv-row mb-10">
            ...
            <!--begin::Tagify-->
            <input class="form-control d-flex align-items-center" value="" id="kt_modal_create_campaign_location" data-kt-flags-path="/metronic8/demo20/assets/media/flags/"/>
            <!--end::Tagify-->
        </div>
        <!--end::Input group-->
...
<!--end::Modal - Create Campaign--><!--begin::Modal - Create App-->
...
<!--end::Modal - Create App--><!--begin::Modal - Offer A Deal-->
